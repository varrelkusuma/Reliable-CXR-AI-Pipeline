...
d_mimic_train_raw = xrv.datasets.MIMIC_Dataset(imgpath="/home/varrel/imaging/all_images/MIMIC_dataset/images_all/preprocess7",
                                           csvpath="/home/varrel/GitHub/CXR-Analysis/final_csv/mimic_train_uignore_fixed.csv",
...
sample_weights = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_train_weights_ignore.npy")
pos_weight_value = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_pos_weight_uignore.npy")[0]
...
for epoch in range(num_epochs):
    ...
    }, f"/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch{epoch+1}_uignore.pth")
    ...
    if val_f1 > best_val_f1:
        torch.save(model.state_dict(), "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_best_model_uignore.pth")
        best_val_f1 = val_f1
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1
...
# ---- Save history JSON ----
with open("/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_training_history_uignore.json", "w") as f:
    json.dump(history, f)
