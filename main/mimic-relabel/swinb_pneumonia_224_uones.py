...
d_mimic_sel_raw = xrv.datasets.MIMIC_Dataset(imgpath="/home/varrel/imaging/all_images/MIMIC_dataset/images_all/preprocess7",
                                         csvpath="/home/varrel/GitHub/CXR-Analysis/final_csv/mimic_selection_uones_fixed.csv",
                                         metacsvpath="/home/varrel/imaging/all_images/MIMIC_dataset/mimic-cxr-2.0.0-metadata.csv",
                                         views=["PA","AP"], unique_patients=False)
...
sample_weights = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_train_weights_ones.npy")
pos_weight_value = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_pos_weight_uones.npy")[0]
...
for epoch in range(num_epochs):
    ...
    }, f"/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch{epoch+1}_uones.pth")
    ...
    if val_f1 > best_val_f1:
        torch.save(model.state_dict(), "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_best_model_uones.pth")
        best_val_f1 = val_f1
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1
...
# ---- Save history JSON ----
with open("/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_training_history_uones.json", "w") as f:
    json.dump(history, f)
