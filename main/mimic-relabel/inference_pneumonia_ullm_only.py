...
# G. Loaders
dataset_loaders = { "MIMIC": torch.utils.data.DataLoader(d_mimic_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate), }

# ---- Load best binary models ----
model_paths = {
    "SwinB-0": "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch2.pth",
    "SwinB-1": "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch3_uones.pth",
    "SwinB-Ignore": "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch2_uignore.pth",
    "SwinB-LLM": "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch3_ullm.pth",
}
...
# Save results
save_path = "/home/varrel/image_model_dict/final/fixed_pneumonia_inference_ullm_only.json"
