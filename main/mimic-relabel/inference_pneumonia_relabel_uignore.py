...
# G. Loaders
dataset_loaders = { "NIH": torch.utils.data.DataLoader(d_nih_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate),
                    ...
                    "Kermany": torch.utils.data.DataLoader(pp_png_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate),
                    "RSNA": torch.utils.data.DataLoader(d_rsna_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate),
...
model_paths = {
    "SwinB": "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch2_uignore.pth",
}
...
# Save results
save_path = "/home/varrel/image_model_dict/final/fixed_pneumonia_inference_uignore.json"
