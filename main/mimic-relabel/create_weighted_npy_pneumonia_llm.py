...
print("Extracting labels with U-LLM policy...")
...
print(f"Dataset Stats (U-LLM): Neg={n_neg}, Pos={n_pos}")
...
np.save("pneumonia_train_weights_llm.npy", sample_weights)
np.save("pneumonia_pos_weight_ullm.npy", np.array([pos_weight_value]))

print(f"Saved 'pneumonia_train_weights_llm.npy' (len={len(sample_weights)})")
print(f"Saved 'pneumonia_pos_weight_ullm.npy' (value={pos_weight_value:.4f})")