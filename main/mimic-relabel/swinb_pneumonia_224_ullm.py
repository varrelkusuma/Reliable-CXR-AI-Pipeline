...
d_mimic_train_raw = xrv.datasets.MIMIC_Dataset(imgpath="/home/varrel/imaging/all_images/MIMIC_dataset/images_all/preprocess7",
                                           csvpath="/home/varrel/GitHub/CXR-Analysis/final_csv/mimic_train_llm_fixed.csv",
...
d_mimic_sel_raw = xrv.datasets.MIMIC_Dataset(imgpath="/home/varrel/imaging/all_images/MIMIC_dataset/images_all/preprocess7",
                                         csvpath="/home/varrel/GitHub/CXR-Analysis/final_csv/mimic_selection_llm_fixed.csv",
                                         metacsvpath="/home/varrel/imaging/all_images/MIMIC_dataset/mimic-cxr-2.0.0-metadata.csv",
                                         views=["PA","AP"], unique_patients=False)
...
dmerge_train = xrv.datasets.MergeDataset([d_nih_train, d_chex_train, d_mimic_train, pc_png_train, openi_png_train, vindr_png_train, pp_png_train, d_rsna_train])
dmerge_selection = xrv.datasets.MergeDataset([d_nih_selection, d_chex_selection, d_mimic_selection, pc_png_selection, openi_png_selection, vindr_png_selection, pp_png_selection, d_rsna_selection])

print(f"Training samples: {len(dmerge_train)}, Selection samples: {len(dmerge_selection)}")

# ---- Load precomputed weights ----
sample_weights = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_train_weights_llm.npy")
pos_weight_value = np.load("/home/varrel/GitHub/CXR-Analysis/model/pneumonia_pos_weight_ullm.npy")[0]
...
for epoch in range(num_epochs):
    ...
    }, f"/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_model_epoch{epoch+1}_ullm.pth")
    ...
    if val_f1 > best_val_f1:
        torch.save(model.state_dict(), "/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_best_model_ullm.pth")
        best_val_f1 = val_f1
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1
...
# ---- Save history JSON ----
with open("/home/varrel/image_model_dict/final/fixed_swinb_pneumonia_training_history_ullm.json", "w") as f:
    json.dump(history, f)
