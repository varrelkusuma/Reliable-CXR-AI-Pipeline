...
pathology_idx = dmerge.pathologies.index("Fracture")
...
np.save("fracture_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as fracture_train_weights.npy (len={len(sample_weights)})")