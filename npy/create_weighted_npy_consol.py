...
pathology_idx = dmerge.pathologies.index("Consolidation")
...
np.save("consolidation_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as consolidation_train_weights.npy (len={len(sample_weights)})")