...
pathology_idx = dmerge.pathologies.index("Pleural Effusion")
...
np.save("effusion_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as effusion_train_weights.npy (len={len(sample_weights)})")