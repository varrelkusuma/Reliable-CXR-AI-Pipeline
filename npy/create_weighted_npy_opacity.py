...
pathology_idx = dmerge.pathologies.index("Lung Opacity")
...
np.save("opacity_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as opacity_train_weights.npy (len={len(sample_weights)})")