...
pathology_idx = dmerge.pathologies.index("Lung Lesion")
...
np.save("lesion_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as lesion_train_weights.npy (len={len(sample_weights)})")