...
pathology_idx = dmerge.pathologies.index("Cardiomegaly")
...
np.save("cardiomegaly_train_weights.npy", sample_weights)
print(f"Weighted sampler saved as cardiomegaly_train_weights.npy (len={len(sample_weights)})")