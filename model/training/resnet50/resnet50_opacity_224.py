...
for epoch in range(num_epochs):
    ...
    }, f"/home/varrel/image_model_dict/final/fixed_resnet50_opacity_model_epoch{epoch+1}.pth")
    ...
    if val_f1 > best_val_f1:
        torch.save(model.state_dict(), "/home/varrel/image_model_dict/final/fixed_resnet50_opacity_best_model.pth")
        best_val_f1 = val_f1
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1
...
# ---- Save history JSON ----
with open("/home/varrel/image_model_dict/final/fixed_resnet50_opacity_training_history.json", "w") as f:
    json.dump(history, f)
