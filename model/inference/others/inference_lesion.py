...
if "Lung Lesion" not in d_nih_raw.pathologies:
    d_nih_raw.pathologies.append("Lung Lesion")

mass_idx = d_nih_raw.pathologies.index("Mass")
nodule_idx = d_nih_raw.pathologies.index("Nodule")

# Original labels shape: (N, 14)
old_labels = d_nih_raw.labels
N, old_len = old_labels.shape
new_len = len(d_nih_raw.pathologies)
...
lunglesion_idx = d_nih_raw.pathologies.index("Lung Lesion")
...
model_paths = {
    "DenseNet": "/home/varrel/image_model_dict/final/fixed_densenet121_lesion_model_epoch6.pth",
    "ResNet": "/home/varrel/image_model_dict/final/fixed_resnet50_lesion_model_epoch6.pth",
    "VitB": "/home/varrel/image_model_dict/final/fixed_vitb_lesion_model_epoch1.pth",
}
...
# Save results
save_path = "/home/varrel/image_model_dict/final/others_lesion_inference.json"
