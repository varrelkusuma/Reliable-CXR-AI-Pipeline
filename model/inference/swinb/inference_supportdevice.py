...
dataset_loaders = {
    ...
    "OX": torch.utils.data.DataLoader(ox_png_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate),
...
model_paths = {
    "SwinB": "/home/varrel/image_model_dict/final/fixed_swinb_supportdevice_model_epoch6.pth",
}
...
# Save results
save_path = "/home/varrel/image_model_dict/final/fixed_supportdevice_inference.json"
