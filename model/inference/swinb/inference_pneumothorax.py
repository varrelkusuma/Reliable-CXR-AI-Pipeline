...
dataset_loaders = {
    ...
    "SIIM": torch.utils.data.DataLoader(siim_png_selection, batch_size=16, shuffle=False, num_workers=8, collate_fn=safe_collate),
...
model_paths = {
    "SwinB": "/home/varrel/image_model_dict/final/fixed_swinb_pneumothorax_model_epoch9.pth",
}
...
# Save results
save_path = "/home/varrel/image_model_dict/final/fixed_pneumothorax_inference.json"
